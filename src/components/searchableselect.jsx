    ...
    <Popover.Root open={open} onOpenChange={setOpen}>
      ...
      <Popover.Portal>
        <Popover.Content
          ...
          align="start"
          side="bottom"
          className="z-[999] mt-1 min-w-96 w-[var(--radix-popover-trigger-width)] rounded-md border-2 border-input bg-popover p-2 text-popover-foreground shadow-md pointer-events-auto"
          sideOffset={4}
        ...
        >
          ...
          <div className="max-h-60 overflow-y-auto overscroll-contain scrollbar-thin scrollbar-thumb-muted-foreground scrollbar-track-transparent">
